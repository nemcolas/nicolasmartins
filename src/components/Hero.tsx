    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-32 pt-40">
        ...
        >
          ...
          >
            <h1
              className="text-[clamp(3rem,10vw,7.5rem)] leading-[1.05] text-white select-none"
              style={{ fontFamily: "var(--font-pixel)" }}
            >
              Nicolas
            </h1>
            <h1
              className="text-[clamp(3rem,10vw,7.5rem)] leading-[1.05] text-zinc-500 select-none"
              style={{ fontFamily: "var(--font-pixel)" }}
            >
              Martins
            </h1>
        ...
        >
          ...
          <a
            ...
            download
            onClick={() => {
              // custom events sao pagos; um pageview virtual aparece em Pages no plano free
              const path = `/cv-download/${lang}`;
