    ...
    <section id="contact" className="py-28 border-t border-zinc-800/40">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2
            className="text-4xl md:text-6xl text-white mb-8 leading-[1.05]"
            style={{ fontFamily: "var(--font-display)" }}
          >
            {t.heading1[lang]}
            <br />
            <span className="italic text-zinc-500">{t.heading2[lang]}</span>
          </h2>
          <p className="text-zinc-500 text-lg leading-relaxed mb-10">{t.desc[lang]}</p>
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-3 px-6 py-3.5 bg-white hover:bg-zinc-100 text-zinc-900 rounded-xl font-medium transition-colors duration-200"
            >
